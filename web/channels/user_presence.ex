defmodule Basedef.UserPresence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Basedef.MyChannel do
        use Basedef.Web, :channel
        alias Basedef.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :basedef,
                        pubsub_server: Basedef.PubSub
end
